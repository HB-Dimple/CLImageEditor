...
- (id)init
{
    ...
    if (self) {
        ...
        self.toolbarColor                   = [UIColor blackColor];//[UIColor colorWithRed:98.0/255.0 green:98.0/255.0 blue:98.0/255.0 alpha:1.0];//[UIColor grayColor];//[UIColor colorWithWhite:1 alpha:0.8];
